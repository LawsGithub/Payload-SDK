...
- 锚点: `feature/liangzhourenwu` @ `a8613c36e350748d8dce1c2c81e9f526491527b8`（2026-09-26 13:40）
- 漂移检查: `git rev-parse HEAD~1` 应 = `a8613c36e350748d8dce1c2c81e9f526491527b8`——HEAD 是本次 handoff 提交，
  其 parent 才是本快照记录的 SHA；变了说明快照可能过期
- **远端已同步到 `4ad2966`** `[V]`（2026-09-25 推送成功）。
  本段（2026-09-26）新增的切片**尚未推送** —— 推送**必须走代理**，
  直连会挂起（见 §5）
...
设备上跑 aarch64 桌面测试：ctest 7/7，lz_test_plan 1144 项检查 0 失败
